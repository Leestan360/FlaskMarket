    ...
    if request.method == "POST":
        ...
        if s_item_object:
            if current_user.can_sell(s_item_object):
                ...
                flash(f"Congratulations! You have sold {s_item_object.name} for {s_item_object.price}$ back to the market", category="success")
            else:
                flash(f"Something went wrong for selling {s_item_object.name}!", category="danger")
